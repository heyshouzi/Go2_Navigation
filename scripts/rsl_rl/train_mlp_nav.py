...
"""
Training script for navigation with MLP-integrated obstacle encoder.

This script registers the custom ActorCriticWithLidarEncoder class
with rsl_rl before training, ensuring proper gradient flow.

Usage:
    ./isaaclab.sh -p scripts/reinforcement_learning/rsl_rl/train_mlp_nav.py \
        --task Isaac-Navigation-Flat-Unitree-Go2-MLP-v0 \
        --num_envs 1024 \
        --headless
"""
