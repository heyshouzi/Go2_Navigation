    ...
    contact_force_penalty = RewTerm(
        ...
        params={
            "sensor_cfg": SceneEntityCfg(
                "contact_forces", 
                body_names=[
                    "base", "Head_upper", "Head_lower",       # 机身+头部
                    "FL_thigh", "FR_thigh", "RL_thigh", "RR_thigh"  # 四条大腿
                ]
            ),         
    ...
    adaptive_distance = CurrTerm(
        ...
        params={
            ...
            "curriculum_levels": [
                ...
                "success_thresholds": [0.60, 0.70, 0.80],  # 升级阈值：60%→档2，70%→档3，80%→档4
...
class NavigationEnvMLPCfg(ManagerBasedRLEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.obstacle_scanner = RayCasterCfg(
            ...
            offset=RayCasterCfg.OffsetCfg(pos=(0.0, 0.0, 0.1)),  # LiDAR安装位置（机身顶部）
            ray_alignment="yaw",
